(function () {
    ...
    app.updateTimetableCard = function (data) {
        ...
        if (app.isLoading) {
            //Para probar la carga de la tarjeta con Lighhouse...
    ...
    app.getSchedule = function (key, label) {
        ...
        //window.callLoadApiTime = performance.now();
        //alert(window.callLoadApiTime);
        if ('caches' in window) {
        ...
        request.onreadystatechange = function () {
            if (request.readyState === XMLHttpRequest.DONE) {
                if (request.status === 200) {
                    //Captura el tiempo del llamado a la API...
                    window.loadApiTime = performance.now();
		...
		req.onsuccess = function(evt) {
			...
			if (cursor) {
				...
				if(i === 0) {
                    ...
                    //Para probar la carga de la llamada  a la API..
                    //window.loadApiTime = performance.now();
				}
				else {
